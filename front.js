...
function updateResultsDisplay(charDist, diffHtml1, diffHtml2, calculationTimeMs, error) {
...
diffForm.addEventListener("submit", async function (event) {
  ...
  try {
    ...
    updateResultsDisplay(charDist, diffHtml1, diffHtml2, calculationTimeMs, error);
